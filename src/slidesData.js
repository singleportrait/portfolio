export const SLIDES = [
  {
    ...
    slides: [
      { name: 'aidin-overview-video', type: 'video', src: './images/aidin-sending-dashboard.png', alt: 'Aidin Dashboard' },
  ...
  },
  {
    ...
    slides: [
      { name: 'genius-video', type: 'video', src: './images/genius-homepage-after-matches-video.png', alt: 'Genius Homepage Redesign' },
  ...
  },
  {
    ...
    slides: [
      { name: 'refinery29-video', type: 'video', src: './images/refinery29-homepage-matches-video.png', alt: 'Refinery29 Homepage' },
